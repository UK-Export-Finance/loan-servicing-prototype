...
function normaliseString(t) {
  ...
  return (
    'true' === e ||
    ('false' !== e && (e.length > 0 && isFinite(Number(e)) ? Number(e) : t))
  )
}
...
class ElementError extends GOVUKFrontendError {
  constructor(t) {
    ...
    if ('object' == typeof t) {
      const { componentName: n, identifier: i, element: s, expectedType: o } = t
      ;(e = `${n}: ${i}`),
        (e += s
...
class I18n {
  ...
  t(t, e) {
    ...
    'number' == typeof (null == e ? void 0 : e.count) &&
      (t = `${t}.${this.getPluralSuffix(t, e.count)}`)
  ...
  getPluralSuffix(t, e) {
    ...
    const n = this.hasIntlPluralRulesSupport()
...
class Accordion extends GOVUKFrontendComponent {
  constructor(e, n = {}) {
    if (
      ...
      (this.browserSupportsSessionStorage = !1),
  ...
  constructHeaderMarkup(t, e) {
    ...
    o.setAttribute('type', 'button'),
      o.setAttribute('aria-controls', `${this.$module.id}-content-${e + 1}`)
    for (const d of Array.from(n.attributes))
      'id' !== d.nodeName && o.setAttribute(d.nodeName, `${d.nodeValue}`)
  ...
  constructor(t, e = {}) {
    ...
    ;(this.$module = t),
      (this.config = mergeConfigs(
        Button.defaults,
        e,
        normaliseDataset(t.dataset),
      )),
      this.$module.addEventListener('keydown', (t) => this.handleKeyDown(t)),
      this.$module.addEventListener('click', (t) => this.debounce(t))
  }
  handleKeyDown(t) {
    const e = t.target
    32 === t.keyCode &&
...
class Checkboxes extends GOVUKFrontendComponent {
  constructor(t) {
    ...
    ;(this.$module = t),
      ...
      this.syncAllConditionalReveals(),
      this.$module.addEventListener('click', (t) => this.handleClick(t))
  }
...
class ExitThisPage extends GOVUKFrontendComponent {
  ...
  handleKeypress(t) {
    this.$updateSpan &&
      (('Shift' !== t.key && 16 !== t.keyCode && 16 !== t.which) ||
...
class SkipLink extends GOVUKFrontendComponent {
  constructor(t) {
    var e
    if ((super(), (this.$module = void 0), !(t instanceof HTMLAnchorElement)))
      throw new ElementError({
